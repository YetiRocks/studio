...
export function DataTable({ records, fields, total, page, pageSize, onPageChange, onUpdate, onDelete }: Props) {
  ...
  function getRecordLabel(record: Record<string, unknown>): string {
    return String(record.id ?? record.name ?? record.username ?? 'this record')
  }
      ...
      {deleteTarget && (
        <div className="modal-overlay" onClick={() => setDeleteTarget(null)}>
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <p className="modal-message">Are you sure you want to delete "{getRecordLabel(deleteTarget)}"? This cannot be undone.</p>
            <div className="modal-actions">
